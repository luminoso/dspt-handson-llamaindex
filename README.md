Repository with the notebooks of the `Hands-on with LlamaIndex: First Steps for Retrieval-Augmented Generation (RAG)` session for the DataScience Portugal #114 meetup
